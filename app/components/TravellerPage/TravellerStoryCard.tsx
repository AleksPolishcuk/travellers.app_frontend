...
import styles from './TravellerCardStory.module.css';
...
export function TravellerStoryCard({ story }: StoryCardProps) {
  const router = useRouter();
  const { user } = useUser();
  const [articlesAmount, setArticlesAmount] = useState(
    story.ownerId.articlesAmount,
  );
  ...
  return (
    <div className={styles.listItem}>
      <div className={styles.storyImg}>
        <img className={styles.listImg} src={story.img} alt={story.title} />
      </div>
      <div className={styles.storyContent}>
        ...
        <div className={styles.user}>
          <div className={styles.imgCard}>
            <img className={styles.userImg} src={story.ownerId.avatarUrl} />
            <div className={styles.userInfo}>
              ...
              <div className={styles.userContent}>
                ...
                <div className={styles.rate}>
                  <span className={styles.userCount}>{articlesAmount}</span>

...
**Travellers App (Подорожники)** — командний навчальний проєкт.  
...
**State Management:**
- [Zustand](https://github.com/pmndrs/zustand) - клієнтський стан (аутентифікація)
- [TanStack Query v5](https://tanstack.com/query) - серверний стан, кешування
...
- Кастомні хуки (useMediaQuery) для адаптивності

**Dev Tools:**

- ESLint + Prettier - лінтинг та форматування
- TanStack Query DevTools - відладка запитів
...
# Заповнити необхідні змінні у .env.local

# 5. Запустити у режимі розробки
npm run dev

# 6. Зібрати білд для продакшену
npm run build

# 7. Запустити продакшен версію
npm start
